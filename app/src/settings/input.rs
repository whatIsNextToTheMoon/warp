...
define_settings_group!(InputSettings,
    settings: [
        ...
        history_open_while_typing: HistoryOpenWhileTyping {
            type: bool,
            default: false,
            supported_platforms: SupportedPlatforms::ALL,
            sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
            surface: settings::SettingSurfaces::GUI,
            private: false,
            toml_path: "terminal.input.history_open_while_typing",
            description: "Whether the history menu opens automatically while typing.",
        },
