...
define_settings_group!(FontSettings,
    settings: [
        ...
        monospace_fallback_font_names: MonospaceFallbackFontNames {
            type: Vec<String>,
            default: Vec::new(),
            supported_platforms: SupportedPlatforms::ALL,
            sync_to_cloud: SyncToCloud::Never,
            surface: settings::SettingSurfaces::GUI,
            private: false,
            storage_key: "FontFallbackNames",
            toml_path: "appearance.text.fallback_font_names",
            description: "An ordered list of fallback fonts used before system font fallback.",
        },
