...
fn recording_summary(props: Props, agent_summary: Option<&str>, app: &AppContext) -> String {
    ...
    agent_summary
        ...
        .unwrap_or_else(|| crate::i18n::ui_str("Recording computer-use session"))
}
    ...
    match result {
        Some(StopRecordingResult::Success(stopped)) => {
            ...
            let subtext = if matches!(
                ...
                format!("{} • {duration}", crate::i18n::ui_str("Partial recording"))
            };
            RecordingCardText {
                primary: crate::i18n::ui_str("Recording saved"),
                subtext: Some(subtext),
            }
        }
        Some(StopRecordingResult::Error(_)) | Some(StopRecordingResult::Cancelled) => {
            RecordingCardText {
                primary: crate::i18n::ui_str("Recording could not be saved"),
                subtext: None,
            }
        }
