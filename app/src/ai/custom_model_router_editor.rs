    ...
    fn render_prompt_section(
        ...
        if !self.prompt_rules.is_empty() {
            ...
            let rules_copy = FormattedText::new([
                FormattedTextLine::Line(vec![FormattedTextFragment::plain_text(crate::i18n::ui_str(
    ...
    fn render_content(&self, appearance: &Appearance, app: &AppContext) -> Box<dyn Element> {
        ...
        let routing_type_copy = FormattedText::new([
            FormattedTextLine::Line(vec![
                FormattedTextFragment::bold(crate::i18n::ui_str("Complexity-based")),
            ...
            FormattedTextLine::Line(vec![
                FormattedTextFragment::bold(crate::i18n::ui_str("Rule-based")),
                FormattedTextFragment::plain_text(crate::i18n::ui_str(
