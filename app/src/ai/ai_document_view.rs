...
impl AIDocumentView {
    pub fn new(
        ...
        let tooltip_text = crate::i18n::ui_str(
            "This plan has changes the agent isn't aware of. {} to stop the agent's current task and send the updated plan",
        )
        .replacen("{}", &save_action, 1);
