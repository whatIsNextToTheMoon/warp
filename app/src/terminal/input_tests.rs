...
mod completion_sources_resolution_tests {
    ...
    #[test]
    fn manual_tab_preserves_native_priority_and_path_completion() {
        assert_eq!(
            CompletionSources::WarpThenNative.for_trigger(CompletionsTrigger::Keybinding, false),
            CompletionSources::NativeThenWarp,
        );
        assert_eq!(
            CompletionSources::WarpThenNative.for_trigger(CompletionsTrigger::Keybinding, true),
            CompletionSources::WarpOnly,
        );
        assert_eq!(
            CompletionSources::WarpOnly.for_trigger(CompletionsTrigger::AsYouType, false),
            CompletionSources::WarpOnly,
        );
        assert_eq!(
            CompletionSources::NativeOnly.for_trigger(CompletionsTrigger::Keybinding, true),
