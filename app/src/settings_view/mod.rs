...
pub mod flags {
    ...
    pub const HISTORY_OPEN_WHILE_TYPING_CONTEXT_FLAG: &str = "History_Open_While_Typing";
    ...
    pub const MANUAL_CODEX_PLAIN_TERMINAL_FLAG: &str = "ManualCodexPlainTerminal";
...
impl<T: Action + Clone> ToggleSettingActionPair<T> {
    ...
    pub fn new(
        ...
        ToggleSettingActionPair {
            descriptions: SettingActionPairDescriptions {
                enable: crate::i18n::ui_text(&format!("Enable {description_suffix}")),
                disable: crate::i18n::ui_text(&format!("Disable {description_suffix}")),
            },
            contexts: SettingActionPairContexts {
...
impl SettingsView {
    ...
    fn should_render_page(&self, settings_page: &SettingsPage, app: &AppContext) -> bool {
        match &settings_page.view_handle {
            ...
            // Hide referral/rewards marketing from the OSS settings UI.
            SettingsPageViewHandle::Referrals(_) => false,
