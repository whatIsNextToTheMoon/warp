...
impl SettingsWidget for UsageWidget {
    ...
    fn render(
            ...
            Flex::row()
                ...
                .with_child(
                    appearance
                        .ui_builder()
                        .paragraph(
                            crate::i18n::ui_str("Resets {formatted_next_refresh_time}").replace(
        ...
        let request_limit_description =
            crate::i18n::ui_str("This is the {} limit of AI credits for your account.").replace(
                "{}",
                &crate::i18n::ui_text(&ai_request_usage_model.refresh_duration_to_string()),
            );
